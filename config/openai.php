...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Additional cURL options for the HTTP client. This is useful for
    | development environments where SSL certificate verification might
    | cause issues.
    */
    'client_options' => [
        'curl' => [
            CURLOPT_SSL_VERIFYPEER => env('APP_ENV') === 'local' ? false : true,
